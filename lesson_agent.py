...
def search_human(name: str) -> str:
    """
    Шукає в інтернеті останні новини про певну людину

    :param name: ім'я людини
    :return: результати пошуку
    """

    results = searcher.results(f'останні новини про людину з ім\'ям {name}')
    print(results)  # результати пошуку
...
messages = [
    SystemMessage(
        """
        Ти агент по пошуку інформації про людей. Твоя задача знайти в інтернеті інформацію про людину по її імені.        
        Якщо користувач введе не ім’я людини, то вивести повідомлення «немає відповідної інформації»

        У тебе є доступ до таких інструментів:
        * search_human -- завжди давай інформацію з новини та посилання на неї
        """
    )
]
